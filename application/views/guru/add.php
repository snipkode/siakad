<div class="mx-auto max-w-3xl rounded-2xl border border-slate-200 bg-white p-4 shadow-sm sm:p-8">
  <h3 class="mb-6 text-lg font-bold text-slate-800">Tambah <?php echo meta_mode_label('label_staf'); ?></h3>
  ...
  <?php echo form_open('guru/add', 'role="form"'); ?>
    ...
    <div class="grid grid-cols-1 gap-5 sm:grid-cols-2">
      <div>
        ...
        <input type="text" name="nuptk" placeholder="Masukkan <?php echo meta_label('guru', 'nomor_induk', 'NUPTK'); ?>"
      ...
      <div>
        ...
        <input type="text" name="nama_guru" placeholder="Masukkan Nama Lengkap <?php echo meta_mode_label('label_staf'); ?>"
               class="w-full rounded-xl border border-slate-300 px-3.5 py-2.5 text-sm focus:border-sky-500 focus:outline-none focus:ring-2 focus:ring-sky-500/30">
      </div>

      <div>
        <label class="mb-1.5 block text-sm font-medium text-slate-700">Gender</label>
        <?php echo form_dropdown('gender', array('Pilih Gender', 'P'=>'Pria', 'W'=>'Wanita'), null, "class='w-full rounded-xl border border-slate-300 px-3.5 py-2.5 text-sm focus:border-sky-500 focus:outline-none focus:ring-2 focus:ring-sky-500/30'"); ?>
      </div>
