  ...
  <div class="rounded-2xl border border-slate-200 bg-white shadow-sm">
    <div class="flex flex-wrap items-center justify-between gap-2.5 border-b border-slate-100 px-4 py-4 sm:px-5">
      <div class="flex items-center gap-3">
        ...
        <div class="min-w-0">
          <h2 class="truncate text-sm font-bold text-slate-800 sm:text-base">Tambah <?php echo $label_kategori; ?></h2>
    ...
    <?php echo form_open('referensi/add/'.$kategori, 'role="form"'); ?>
      <div class="grid grid-cols-1 gap-4 px-4 py-5 sm:grid-cols-2 sm:gap-5 sm:px-5 sm:py-6">
        ...
        <div>
          ...
          <input type="number" name="urutan" value="0" class="w-full rounded-xl border border-slate-300 bg-white px-3 py-2.5 text-sm shadow-sm focus:border-sky-400 focus:outline-none focus:ring-2 focus:ring-sky-100">
        </div>
        ...
        <?php if ($is_mapel): ?>
          <div>
            ...
            <input type="number" name="attr_sks" min="0" max="12" value="3" class="w-full rounded-xl border border-slate-300 bg-white px-3 py-2.5 text-sm shadow-sm focus:border-sky-400 focus:outline-none focus:ring-2 focus:ring-sky-100">
          </div>
          <div>
            <label class="mb-1.5 block text-xs font-semibold uppercase tracking-wide text-slate-500">Jenjang</label>
            <input type="text" name="attr_jenjang" placeholder="mis. S1 / D3" class="w-full rounded-xl border border-slate-300 bg-white px-3 py-2.5 text-sm shadow-sm focus:border-sky-400 focus:outline-none focus:ring-2 focus:ring-sky-100">
          </div>
        <?php endif; ?>
        ...
        <?php if ($kategori === 'PRODI'): ?>
          <div>
            ...
            <input type="text" name="attr_akreditasi" placeholder="A / B / C" class="w-full rounded-xl border border-slate-300 bg-white px-3 py-2.5 text-sm shadow-sm focus:border-sky-400 focus:outline-none focus:ring-2 focus:ring-sky-100">
          </div>
        <?php endif; ?>
        ...
        <div class="sm:col-span-2">
          ...
          <div class="flex w-fit gap-1 rounded-xl border border-slate-300 bg-slate-50 p-1 shadow-sm">
            <label class="cursor-pointer">
              <input type="radio" name="is_aktif" value="Y" checked class="peer sr-only">
            ...
            <label class="cursor-pointer">
              <input type="radio" name="is_aktif" value="N" class="peer sr-only">
