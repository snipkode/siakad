<div class="mx-auto max-w-2xl rounded-2xl border border-slate-200 bg-white p-4 shadow-sm sm:p-8">
  <h3 class="mb-6 text-lg font-bold text-slate-800">Form Edit Kelas</h3>
  ...
  <?php echo form_open('kelas/edit', 'role="form"'); ?>
    ...
    <div class="grid grid-cols-1 gap-5 sm:grid-cols-2">
      ...
      <div>
        ...
        <input type="text" value="<?php echo $kelas['nama_kelas']; ?>" name="nama_kelas" placeholder="Masukkan Nama Kelas"
      ...
      <div>
        ...
        <?php echo cmb_dinamis('tingkatan', 'tbl_tingkatan_kelas', 'nama_tingkatan', 'kd_tingkatan', $kelas['kd_tingkatan']); ?>
      </div>
      <div>
