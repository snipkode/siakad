<div class="mx-auto max-w-2xl rounded-2xl border border-slate-200 bg-white p-4 shadow-sm sm:p-8">
  <h3 class="mb-6 text-lg font-bold text-slate-800">Form Tambah <?php echo meta_mode_label('label_mata_ajar'); ?></h3>
  ...
  <?php echo form_open('mapel/add', 'role="form"'); ?>
    ...
    <div class="grid grid-cols-1 gap-5 sm:grid-cols-2">
      <div>
        ...
        <input type="text" name="kd_mapel" placeholder="Masukkan Kode <?php echo meta_mode_label('label_mata_ajar'); ?>"
      ...
      <div>
        ...
        <input type="text" name="nama_mapel" placeholder="Masukkan Nama <?php echo meta_mode_label('label_mata_ajar'); ?>"
               class="w-full rounded-xl border border-slate-300 px-3.5 py-2.5 text-sm focus:border-sky-500 focus:outline-none focus:ring-2 focus:ring-sky-500/30">
      </div>
    </div>
