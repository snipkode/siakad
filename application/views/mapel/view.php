<div class="rounded-2xl border border-slate-200 bg-white shadow-sm">
  <div class="flex flex-wrap items-center justify-between gap-3 border-b border-slate-100 px-4 py-4 sm:px-5">
    <div class="flex items-center gap-3">
      <span class="hidden h-10 w-10 items-center justify-center rounded-xl bg-gradient-to-br from-teal-500 to-emerald-600 text-white shadow-md sm:inline-flex">
    ...
    <div class="flex flex-wrap gap-2 dt-actions">
      <?php
    echo anchor('mapel/add', '<i class="fa fa-plus"></i> Tambah Data', array('class'=>'inline-flex items-center gap-1.5 rounded-xl bg-sky-600 px-3 py-2 text-xs font-semibold text-white shadow-sm hover:bg-sky-700'));
  ?>
    </div>
  </div>
...
{ "data": null, "width": "45px", "class": "text-center", "orderable": false },
        { "data": "kd_mapel", "width": "150px", "class": "text-center font-mono" },
        { "data": "nama_mapel" },
    ...
    t.on('draw.dt', function () {
      $('#total-mapel').text(t.page.info().recordsTotal);
